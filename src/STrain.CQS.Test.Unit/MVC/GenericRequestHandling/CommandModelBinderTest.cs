...
namespace STrain.CQS.Test.Unit.MVC.GenericRequestHandling
{
	public class CommandModelBinderTest
	{
		...
		public async Task CommandModelBinder_BindModelAsync_EmptyContent()
		{
			...
			// Act
			// Assert
			await Assert.ThrowsAsync<ArgumentNullException>(async () => await sut.BindModelAsync(modelBindingContextMock.Object));
		}
	}

	file static class CommandModelBinderTestExtensions
	{
