...
{
    public class RequestSendingStepDefinitionsOld
    {
        ...
        private GenericCommand? _command;
        private readonly GenericQuery? _query;
        ...
        public RequestSendingStepDefinitionsOld(RequestContext requestContext, ITestOutputHelper outputHelper)
        {
        ...
        {
            _command = new Fixture().Create<GenericCommand>();
        ...
        public async Task GenericRequestResponseAsync(Table dataTable)
        {
            ...
            _requestContext.Request = _forwardCommand.Resource;
        ...
        {
            await _driver.SendCommandAsync(new Fixture().Create<GenericCommand>(), TimeSpan.FromSeconds(5));
        }
