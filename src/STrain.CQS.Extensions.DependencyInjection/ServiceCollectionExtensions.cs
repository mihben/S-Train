...
namespace Microsoft.Extensions.DependencyInjection
{
	...
	public static class ServiceCollectionExtensions
	{
		...
		public static IHttpClientBuilder AddHttpRequestSender(this IServiceCollection services, string key, Action<HttpRequestSenderOptions, IConfiguration> configure, Action<HttpClient>? build = null)
		{
			...
			return services.AddHttpClient(key, (provider, client) =>
			{
