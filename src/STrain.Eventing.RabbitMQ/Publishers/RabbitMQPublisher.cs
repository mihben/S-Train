...
namespace STrain.Eventing.RabbitMQ.Publishers
{
    public class RabbitMQPublisher : IPublisher
    {
        ...
        {
            _logger.LogDebug("Initializing publisher of {Exchange}", _options.Exchange);

            await _channel.ExchangeDeclareAsync(_options.Exchange, _options.Type, true, false, null, false, false, cancellationToken);

            _logger.LogDebug("Publisher of {Exchange} has been initialized", _options.Exchange);
        }
